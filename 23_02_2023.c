...
void zad_1_2_7() {
    ...
    printf("%d", liczba); // Nie zmienia wartości liczby
}
...
void zad_1_2_8() {
    ...
    // Inaczej będzie wynik w int a nie w double, jak będzie samo 3, a nie 3.0f

    printf("%lf\n", srednia);
}

void zad_1_2_9() {
    // unsigned int - nie działa w c
    double a;
...
void zad_1_2_12() {
    ...
    // notacji wykładniczej - notacja naukowa  0.2 to 2.0e-1
}
